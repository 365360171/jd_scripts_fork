/*
东东超市兑换奖品 脚本地址：https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_blueCoin.js
感谢@yangtingxiao提供PR
更新时间：2021-6-7
...
[task_local]
#东东超市兑换奖品
59 23 * * * https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_blueCoin.js, tag=东东超市兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true

====================Loon=================
[Script]
cron "59 23 * * *" script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_blueCoin.js,tag=东东超市兑换奖品

===================Surge==================
东东超市兑换奖品 = type=cron,cronexp="59 23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_blueCoin.js

============小火箭=========
东东超市兑换奖品 = type=cron,script-path=https://raw.githubusercontent.com/LingFeng0918/jd_scripts/master/jd_blueCoin.js, cronexpr="59 23 * * *", timeout=3600, enable=true
 */
  ...
  if (prizeList && prizeList.length) {
    if (`${coinToBeans}` === '1000') {
      ...
      if (prizeList[0] && prizeList[0].type === 3) {
        console.log (JSON.stringify(prizeList[3]))
      ...
      for (let index = 0; index < prizeList.length; index ++) {
        ...
        //console.log (index)
        //console.log (JSON.stringify(prizeList[index]))
      }
      if (prizeId) {
