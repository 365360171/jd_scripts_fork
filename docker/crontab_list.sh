...
# 京喜财富岛合成月饼
10 6,13,23 * * * node /scripts/jd_cfd_mooncake.js >> /scripts/logs/jd_cfd_mooncake.log 2>&1
# 临期京豆兑换为喜豆
...
# 京豆变动通知2
30 22 * * * node /scripts/jd_bean_changes.js >> /scripts/logs/jd_bean_changes.log 2>&1
# 京东排行榜
